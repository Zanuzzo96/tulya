...
<body>
	...
	<div class="container">
		...
		<div class="col-xs-10 col-xs-offset-1 col-md-12 col-lg-11">
		    ...
		    <h2 class="text-center">PUBLICAÇÕES DA GALERIA</h2><br>
		        ...
		        <?php $result = $select->fetchAll(); foreach($result as $row){?>      
		            <div class="col-md-8 postagem">
		                ...
		                <div class="col-md-8">
		                    ...
		                    <div class="col-md-12">
		                         <a class="btn btn-lg btn-default" href="excluir.php?id=<?php echo $row['imagem']; ?>&pagina=galeria">Apagar Postagem</a>
		                    </div>
		                </div>
